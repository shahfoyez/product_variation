<!--begin::Filter-->
<button type="button" class="btn btn-light-primary me-2 border border-secondary py-4" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                ...
                <div class="mb-10">
                    ...
                    <div class="d-flex flex-column flex-wrap fw-bold" data-kt-docs-table-filter="payment_type">
                        ...
                        <label class="form-check form-check-sm form-check-custom form-check-solid mb-3">
                            <input class="form-check-input" type="radio" name="status" value="available"  {{ $filter == 'available' ? 'checked' : '' }}/>
                            <span class="form-check-label text-gray-600">Available</span>
                        </label>
                        <!--end::Option-->
                        <!--begin::Option-->
                        <label class="form-check form-check-sm form-check-custom form-check-solid mb-3">
                            <input class="form-check-input" type="radio" name="status" value="trip" {{ $filter == 'trip' ? 'checked' : '' }}/>
                            <span class="form-check-label text-gray-600">In Trip</span>
                        </label>
                        <!--end::Option-->
                        <!--begin::Option-->
                        <label class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input" type="radio" name="status" value="maintenance" {{ $filter == 'maintenance' ? 'checked' : '' }}/>
